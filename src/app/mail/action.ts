...
export async function generate(input: string) {
    ...
    (async () => {
        const { textStream } = await streamText({
            ...
            Keep the tone of the text consistent with the rest of the email.
            Keep the response short and sweet. Act like a copilot, finish my sentence if needed, but do not try to generate a new paragraph.
